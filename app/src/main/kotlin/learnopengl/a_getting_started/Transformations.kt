...
class Transformations {
    ...
    fun main() {
        ...
        val ourShader = Shader(
            "/shaders/a_getting_started/transformations/transform.vert",
            "/shaders/a_getting_started/transformations/transform.frag",
        )
        ...
        while (!glfwWindowShouldClose(window)) {
            ...
            val transform = Mat4()
                ...
                .rotate(glfwGetTime().toFloat(), 0f, 0f, 1f)

            // get matrix's uniform location and set matrix
            ourShader.use()
            val transformLoc = glGetUniformLocation(ourShader.id, "transform")
            glUniformMatrix4fv(transformLoc,  false, transform.toFloatArray())
